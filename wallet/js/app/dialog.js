        ...
        redbagLottery: {
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-redbag" id="redbag-dialog">')
                    ...
                    ._('<a href="javascript:void(0);" class="btn-lottery btn-redbag-get" id="btn-redbagLottery-use" data-collect="true" data-collect-flag="dialog-redbag-btn-redbagLottery-use" data-collect-desc="弹层(红包)-领取红包按钮">立即领取&gt;</a>')
                    ._('</section>')
                    ._('</fieldset>')
                    ._('</section>')
                    ._('</section>');
        ...
        shiwuLottery: {
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-shiwu" id="shiwu-dialog">')
                    ...
                    ._('</section>')
                    ._('<section class="btn-lottery-box">')
                    ._('<a href="javascript:void(0);" class="btn-lottery btn-wxcard-lottery-award" id="btn-shiwuLottery-award" data-collect="true" data-collect-flag="dialog-wxcard-btn-shiwuLottery-award" data-collect-desc="弹层(实物)-领取按钮">立即领取&gt;</a>')
                    ._('</section>')
                    ._('</fieldset>')
                    ._('</section>')
                    ._('</section>');
        ...
        linkLottery: {
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-link" id="link-dialog">')
                    ...
                    ._('<img class="award-img" src="">')
                    ._('<section class="btn-lottery-box">')
                    ._('<a href="javascript:void(0);" class="btn-lottery btn-link-use" id="btn-linkLottery-use" data-collect="true" data-collect-flag="dialog-link-btn-linkLottery-use" data-collect-desc="弹层(外链)-立即领取按钮">立即领取&gt;</a>')
                    ._('</section>')
                    ._('</fieldset>')
                    ._('</section>')
                    ._('</section>');
        ...
        duiHuanMaLottery: {
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-link" id="dhm-dialog">')
                    ...
                    ._('<section class="btn-lottery-box">')
                    ._('<a href="javascript:void(0);" class="btn-lottery btn-redbag-get" id="btn-djmLottery-use" data-collect="true" data-collect-flag="dialog-redbag-btn-redbagLottery-use" data-collect-desc="弹层(兑换码)-领取兑换码按钮">立即领取&gt;</a>')
                    ._('</section>')
                    ._('</fieldset>')
                    ._('</section>')
                    ._('</section>');
        ...
        thanks: {
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-thanks" id="thanks-dialog">')
                    ...
                    ._('<fieldset class="dialog-content">')
                            ._('<img class="icon-thanks" src="images/thanks-code.png">')
                            ._('<h3 class="tlt">长按识别图中二维码，更多精彩等着你</h3>')
                        ._('</fieldset>')
                    ._('</section>')
                    ._('</section>');
                return t.toString();
